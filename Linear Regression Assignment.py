...
# Program Description: This code take two input txt file with initial weights 
# calculate the prediction, error, error squared, Error Delta for W1 W2 for first 
# input file and W1 W2 W3 for input file two. Then the program calculates the new weights 
# using a learning rate of 0.0000002 for file one  and 0.00002 for file two  
# and calulates thee above again upadating weights after each iteration
...
# Input 1 method
def input_1():
    print('\nData File: LRA_input1.txt')
    data = np.genfromtxt('LRA_input1.txt', delimiter=',')
...
# Input 2 Method
def input_2():
    print('\n\n\nData File: LRA_input2.txt')
    data = np.genfromtxt('LRA_input2.txt', delimiter=',')
